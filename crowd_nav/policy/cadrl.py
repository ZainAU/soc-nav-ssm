...
class CADRL(Policy):
    def __init__(self):
        ...
        self.done = False # Making this variable so that I could reset the internal state once the episode is done (for testing/inferencing)
    ...
    def predict(self, state):
        ...
        if self.phase == 'train' and probability < self.epsilon:
            ...
            for action in self.action_space:
                ...
                # VALUE UPDATE
                outputs = self.model(self.rotate(batch_next_states)) # quering the model here
