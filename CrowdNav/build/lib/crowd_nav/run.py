...
def main(run_type:  str     = 'test',
    ...
    if run_type == 'test':
        ...
        commands = [
            f"python test.py --policy {policy} --model_dir {model_dir} --il --phase test --env_config configs/env_multi-test_bl-cr.config {gpu_option}",
            f"python test.py --policy {policy} --model_dir {model_dir} --il --phase test --env_config configs/env_multi-test_bl-sq.config {gpu_option}",
            f"python test.py --policy {policy} --model_dir {model_dir} --il --phase test --env_config configs/env_multi-test_dn-cr.config {gpu_option}",
            f"python test.py --policy {policy} --model_dir {model_dir} --il --phase test --env_config configs/env_multi-test_dn-sq.config {gpu_option}",
            f"python test.py --policy {policy} --model_dir {model_dir} --il --phase test --env_config configs/env_multi-test_lg-cr.config {gpu_option}",
            f"python test.py --policy {policy} --model_dir {model_dir} --il --phase test --env_config configs/env_multi-test_lg-sq.config {gpu_option}"
        ]
